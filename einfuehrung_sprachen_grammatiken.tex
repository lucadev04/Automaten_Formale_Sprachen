...
\begin{frame}{Ableitungsbaum}
	\begin{itemize}
		...
		\begin{itemize}
			\item Operatoren, die im Ableitungsbaum tiefer liegen, haben bei der Ausführung höhere Priorität
      \item Parser erzeugt Ableitungsbaum bottom-up durch Ableitung des Startsymbols aus dem Terminalwort
...
\begin{frame}{Avram Noam Chomsky (\textborn 1928)}
	\begin{columns}
		...
		\begin{itemize}
			...
			\item Schriften:
			\begin{itemize}
				\item \emph{Syntactic Structures} (1957)
