	...
	\begin{columns}
		\column{.8\textwidth}
			\begin{itemize}
				...
				\begin{itemize}
					\item {\small \url{https://github.com/bluepoke/Automaten_Formale_Sprachen/releases/latest}}
					\item {\small \url{https://bildungsportal.sachsen.de/opal/auth/RepositoryEntry/32431800327/CourseNode/1725762633373559011/AuFS.pdf}}
				\end{itemize}
		...
		\column{.2\textwidth}
				...
				GitHub\\
				\vspace{1cm}
				\qrcode[height=0.9\textwidth]{https://bildungsportal.sachsen.de/opal/auth/RepositoryEntry/32431800327/CourseNode/1725762633373559011/AuFS.pdf}\\
				OPAL
	\end{columns}
\end{frame}
